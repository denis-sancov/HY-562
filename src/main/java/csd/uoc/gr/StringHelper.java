...
public class StringHelper {
    ...
    static final List stopWords = Arrays.asList(
    ...
    public static String stringByFilterString(String sentence) throws IOException {
        sentence = sentence.replaceAll("<[^>]*>","");
        sentence = sentence.replaceAll("[^\\w\\s]"," ");
        return removeStopWordsFromSentence(sentence).trim();
    }
